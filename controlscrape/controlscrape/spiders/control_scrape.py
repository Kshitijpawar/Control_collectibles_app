...
class ControlMultimediaSpider(scrapy.Spider):
    name = "control_multimedia_scraper"
    start_urls = [
        "https://control.fandom.com/wiki/Category:Collectibles_/_Multimedia",
    ]
    json_content = {}
    new_json = {}
    ...
    def closed(self, reason):
        ...
        #     json.dump(self.json_content, fout, indent=4)
        with open(
            f"/home/kshitij/Desktop/control_project/Control_collectibles_app/json_files/multimedia.json",
            "w",
            encoding="utf-8",
        ) as fout:
            json.dump(self.new_json, fout, indent=4)
